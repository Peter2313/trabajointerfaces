...
import com.mycompany.Controlador.sqlhelperinscrientrenador;
...
public class inscrientrenador extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    tfnombre.setToolTipText("nombre de entrenador");
    tfnombre.setPreferredSize(new java.awt.Dimension(263, 42));

    tfclocal.setToolTipText("camiseta local color");
    tfclocal.setPreferredSize(new java.awt.Dimension(263, 42));

    tfcvisitante.setToolTipText("camiseta visitante color");
