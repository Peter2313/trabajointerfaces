 ...
 */
public class inscriequipo extends javax.swing.JPanel {

  private sqlhelperinscriequipo sql = new sqlhelperinscriequipo();
  /**
  ...
  private void initComponents() {
    ...
    tfnombre.setToolTipText("nombre equipo");
    tfnombre.setPreferredSize(new java.awt.Dimension(263, 42));

    tfestadio.setToolTipText("Estadio equipo");
    tfestadio.setPreferredSize(new java.awt.Dimension(263, 42));

    tfciudad.setToolTipText("ciudad equipo");
    tfciudad.setPreferredSize(new java.awt.Dimension(263, 42));

    tfnombrepresi.setToolTipText("nombre del presidente login");
